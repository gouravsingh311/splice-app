...
const CHANNEL_NAME_PATTERN = /^fileeaters\.[a-z0-9.-]+\.v\d+$/;
...
const IPC_CHANNELS = Object.freeze({
  ...
  AUDIT_EVENTS_LIST: "fileeaters.audit.events.list.v1",
  AUDIT_EVENTS_EXPORT: "fileeaters.audit.events.export.v1",
