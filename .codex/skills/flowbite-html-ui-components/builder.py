#!/usr/bin/env python3
"""
Flowbite Skill Builder

This script processes Flowbite documentation files:
...
5. Updates SKILL.md with a comprehensive index of all components
"""
...
def process_markdown_content(content: str, relative_path: str, references_root: Path) -> Dict:
    ...
    return {
        'title': cleaned_title,
        'description': frontmatter.get('description', 'Component documentation'),
