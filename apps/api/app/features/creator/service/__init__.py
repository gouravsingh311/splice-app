"""Creator service — helpers, DB accessors, and Airtable sync orchestration."""
...
from app.features.creator.airtable_sync import (
    AIRTABLE_TABLE_DEFAULT,
    AIRTABLE_VIEW_DEFAULT,
    create_airtable_record_for_submission,
    fetch_airtable_records_for_submission,
)

from .helpers import (
    apply_airtable_metadata_update as apply_airtable_metadata_update,
)
from .helpers import (
    build_airtable_link_state_response as build_airtable_link_state_response,
)
from .helpers import (
    creator_approval_email_enabled as creator_approval_email_enabled,
)
from .helpers import (
    ensure_submission_owned as ensure_submission_owned,
)
from .helpers import (
    fetch_airtable_link_row as fetch_airtable_link_row,
)
from .helpers import (
    fetch_submission_metadata_row as fetch_submission_metadata_row,
)
from .helpers import (
    normalize_creator_defaults as normalize_creator_defaults,
)
from .helpers import (
    normalize_sync_status as normalize_sync_status,
)
from .helpers import (
    now_iso as now_iso,
)
...
from .helpers import (
    query_submission_row as query_submission_row,
)
from .helpers import (
    resolve_actor_scoped_id as resolve_actor_scoped_id,
)
from .helpers import (
    row_to_submission as row_to_submission,
)
from .helpers import (
    sort_records_by_created_at as sort_records_by_created_at,
)
from .helpers import (
    to_json as to_json,
)
from .helpers import (
    upsert_airtable_link_row as upsert_airtable_link_row,
)
    ...
    *,
    ...
    if metadata_row is None and link_row is not None:
        upsert_airtable_link_row(
            ...
            airtable_table_name=link_row["airtable_table_name"] or AIRTABLE_TABLE_DEFAULT,
            airtable_view_name=link_row["airtable_view_name"] or AIRTABLE_VIEW_DEFAULT,
    ...
    next_error_detail = (
        None if record.required_fields_complete
        else "Label Name, Pack Name, and Release Month are required in Airtable."
    )
    upsert_airtable_link_row(
        connection,
